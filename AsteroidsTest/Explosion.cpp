...
Explosion::Explosion(const D3DXVECTOR3 &position,
...
void Explosion::Render(Graphics *graphics) const
{
	...
	DummyVert square[5] =
	{
		{ -1.0f, -1.0f, 0.0f,  D3DCOLOR_RGBA(240,128,128,1)},
		{ -1.0f,  1.0f, 0.0f,  D3DCOLOR_RGBA(240,128,128,1) },
		{ 1.0f,  1.0f, 0.0f,  D3DCOLOR_RGBA(240,128,128,1) },
		{ 1.0f, -1.0f, 0.0f,   D3DCOLOR_RGBA(240,128,128,1) },
		{ -1.0f, -1.0f, 0.0f,   D3DCOLOR_RGBA(240,128,128,1) },
...
D3DXVECTOR3 Explosion::GetVelocity() const
{
	return velocity_;
}

int Explosion::GetSize() const
{
	return size_;
}
